...
class StBestSellers extends Module
{
    ...
    public static $sort_by = array(
        ...
        7 => array('id' =>7 , 'name' => 'Price: Highest first'),
        8 => array('id' =>8 , 'name' => 'Sales: Highest first'),
    );
	...
	function install()
	{
		if (!Configuration::updateValue('ST_SELLERS_NBR', 8) 
            || !parent::install() 
            ...
            || !Configuration::updateValue('ST_SELLERS_EASING', 0)
            || !Configuration::updateValue('ST_SELLERS_SLIDESHOW', 0)
            || !Configuration::updateValue('ST_SELLERS_S_SPEED', 7000)
            || !Configuration::updateValue('ST_SELLERS_A_SPEED', 400)
            || !Configuration::updateValue('ST_SELLERS_PAUSE_ON_HOVER', 1)
            || !Configuration::updateValue('ST_SELLERS_LOOP', 0)
            || !Configuration::updateValue('ST_SELLERS_MOVE', 0)
            || !Configuration::updateValue('ST_SELLERS_ITEMS', 4)
            || !Configuration::updateValue($this->_prefix_st.'COUNTDOWN_ON', 1)
            || !Configuration::updateValue('ST_SELLERS_NBR_COL', 8) 
            || !Configuration::updateValue('ST_SELLERS_DISPLAY_PRO_COL', 0) 
            || !Configuration::updateValue('ST_SELLERS_EASING_COL', 0)
            || !Configuration::updateValue('ST_SELLERS_SLIDESHOW_COL', 0)
            || !Configuration::updateValue('ST_SELLERS_S_SPEED_COL', 7000)
            || !Configuration::updateValue('ST_SELLERS_A_SPEED_COL', 400)
            || !Configuration::updateValue('ST_SELLERS_PAUSE_ON_HOVER_COL', 1)
            || !Configuration::updateValue('ST_SELLERS_LOOP_COL', 0)
            || !Configuration::updateValue('ST_SELLERS_MOVE_COL', 0)
            || !Configuration::updateValue('ST_SELLERS_ITEMS_COL', 4)
            || !Configuration::updateValue('ST_SELLERS_SOBY', 1)
            || !Configuration::updateValue('ST_SELLERS_SOBY_COL', 1)
            || !Configuration::updateValue('ST_SELLERS_HIDE_MOB', 0)
            || !Configuration::updateValue('ST_SELLERS_HIDE_MOB_COL', 0)
            || !Configuration::updateValue($this->_prefix_st.'COUNTDOWN_ON_COL', 1)
            || !Configuration::updateValue('ST_SELLERS_NBR_FOT', 4) 
            || !Configuration::updateValue('ST_SELLERS_SOBY_FOT', 1)
            || !Configuration::updateValue('ST_SELLERS_DISPLAY_SD', 0)
            || !Configuration::updateValue('ST_SELLERS_AW_DISPLAY', 1)
            || !Configuration::updateValue('ST_SELLERS_AW_DISPLAY_COL', 1)
            || !Configuration::updateValue('ST_SELLERS_AW_DISPLAY_FOT', 1)
            || !Configuration::updateValue('ST_SELLERS_GRID', 0)
            || !Configuration::updateValue('STSN_SELLERS_PRO_PER_LG_0', 4)
            || !Configuration::updateValue('STSN_SELLERS_PRO_PER_MD_0', 4)
            || !Configuration::updateValue('STSN_SELLERS_PRO_PER_SM_0', 3)
            || !Configuration::updateValue('STSN_SELLERS_PRO_PER_XS_0', 2)
            || !Configuration::updateValue('STSN_SELLERS_PRO_PER_XXS_0', 1)
            //
    ...
    public function getContent()
	{
                ...
                foreach($form['form']['input'] as $field)
                    if(isset($field['validation']))
                    {
                        ...
                        elseif($value==false)
                        {
                            ...
                            Configuration::updateValue('ST_SELLERS_'.strtoupper($field['name']), $value);
                        }
                        else
                            Configuration::updateValue('ST_SELLERS_'.strtoupper($field['name']), $value);
                    }
        ...
        $this->fields_form[0]['form']['input']['sellers_pro_per_0']['name'] = $this->BuildDropListGroup($this->findCateProPer());
    ...
    public function initFieldsForm()
    {
		$this->fields_form[0]['form'] = array(
			...
			'input' => array(
                ...
                'sellers_pro_per_0' => array(
                    'type' => 'html',
                    'id' => 'sellers_pro_per_0',
    ...
    public function hookDisplayHeader($params)
    {
        ...
        {
            $custom_css = '';
            $title_block_no_bg = '.best-sellers_block_center_container .title_block, .best-sellers_block_center_container .nav_top_right .flex-direction-nav,.best-sellers_block_center_container .title_block a, .best-sellers_block_center_container .title_block span{background:none;}';
            ...
            if($group_css)
                $custom_css .= '.best-sellers_block_center_container{background-attachment:fixed;'.$group_css.'}'.$title_block_no_bg;

            if ($top_padding = (int)Configuration::get($this->_prefix_st.'TOP_PADDING'))
                $custom_css .= '.best-sellers_block_center_container{padding-top:'.$top_padding.'px;}';
            if ($bottom_padding = (int)Configuration::get($this->_prefix_st.'BOTTOM_PADDING'))
                $custom_css .= '.best-sellers_block_center_container{padding-bottom:'.$bottom_padding.'px;}';

            $top_margin = Configuration::get($this->_prefix_st.'TOP_MARGIN');
            if($top_margin || $top_margin!==null)
                $custom_css .= '.best-sellers_block_center_container{margin-top:'.$top_margin.'px;}';
            $bottom_margin = Configuration::get($this->_prefix_st.'BOTTOM_MARGIN');
            if($bottom_margin || $bottom_margin!==null)
                $custom_css .= '.best-sellers_block_center_container{margin-bottom:'.$bottom_margin.'px;}';

            if (Configuration::get($this->_prefix_st.'TITLE_ALIGNMENT'))
                $custom_css .= '.best-sellers_block_center_container .title_block{text-align:center;}'.$title_block_no_bg;
            ...
            {
                 $custom_css .= '.best-sellers_block_center_container .title_block{font-size:'.$title_font_size.'px;}';
                 $custom_css .= '.best-sellers_block_center_container .nav_top_right .flex-direction-nav{top:-'.(round((round($title_font_size*1.3)-24)/2)+24+22).'px;}';
            }
            
            if ($title_color = Configuration::get($this->_prefix_st.'TITLE_COLOR'))
                $custom_css .= '.best-sellers_block_center_container.block .title_block a, .best-sellers_block_center_container.block .title_block span{color:'.$title_color.';}';
            if ($title_hover_color = Configuration::get($this->_prefix_st.'TITLE_HOVER_COLOR'))
                $custom_css .= '.best-sellers_block_center_container.block .title_block a:hover{color:'.$title_hover_color.';}';

            if ($text_color = Configuration::get($this->_prefix_st.'TEXT_COLOR'))
                $custom_css .= '.best-sellers_block_center_container .s_title_block a,
                .best-sellers_block_center_container .price,
                .best-sellers_block_center_container .old_price,
                .best-sellers_block_center_container .product_desc{color:'.$text_color.';}';

            if ($price_color = Configuration::get($this->_prefix_st.'PRICE_COLOR'))
                $custom_css .= '.best-sellers_block_center_container .price{color:'.$price_color.';}';
            if ($link_hover_color = Configuration::get($this->_prefix_st.'LINK_HOVER_COLOR'))
                $custom_css .= '.best-sellers_block_center_container .s_title_block a:hover{color:'.$link_hover_color.';}';

            if ($grid_hover_bg = Configuration::get($this->_prefix_st.'GRID_HOVER_BG'))
                $custom_css .= '.best-sellers_block_center_container .products_slider .ajax_block_product:hover .pro_second_box, .best-sellers_block_center_container .product_list.grid .ajax_block_product:hover .pro_second_box{background-color:'.$grid_hover_bg.';}';

            if ($direction_color = Configuration::get($this->_prefix_st.'DIRECTION_COLOR'))
                $custom_css .= '.best-sellers_block_center_container .flex-direction-nav a{color:'.$direction_color.';}';
            if ($direction_bg = Configuration::get($this->_prefix_st.'DIRECTION_BG'))
                $custom_css .= '.best-sellers_block_center_container .flex-direction-nav a{background-color:'.$direction_bg.';}';
            if ($direction_hover_bg = Configuration::get($this->_prefix_st.'DIRECTION_HOVER_BG'))
                $custom_css .= '.best-sellers_block_center_container .flex-direction-nav a:hover{background-color:'.$direction_hover_bg.';}';
            if ($direction_disabled_bg = Configuration::get($this->_prefix_st.'DIRECTION_DISABLED_BG'))
                $custom_css .= '.best-sellers_block_center_container .flex-direction-nav a.flex-disabled{background-color:'.$direction_disabled_bg.';}';
	...
	public function hookDisplayHome($params, $hook_hash = '', $flag=0)
	{
	    ...
	    if (Configuration::get('ST_SELLERS_GRID') || !$this->isCached('stbestsellers.tpl', $this->stGetCacheId($hook_hash)))
    	{
            ...
            $this->smarty->assign(array(
                ...
                'pro_per_lg'       => (int)Configuration::get('STSN_SELLERS_PRO_PER_LG_0'),
                'pro_per_md'       => (int)Configuration::get('STSN_SELLERS_PRO_PER_MD_0'),
                'pro_per_sm'       => (int)Configuration::get('STSN_SELLERS_PRO_PER_SM_0'),
                'pro_per_xs'       => (int)Configuration::get('STSN_SELLERS_PRO_PER_XS_0'),
                'pro_per_xxs'      => (int)Configuration::get('STSN_SELLERS_PRO_PER_XXS_0'),
		...
		return $this->display(__FILE__, 'stbestsellers.tpl', Configuration::get('ST_SELLERS_GRID') ? NULL : $this->stGetCacheId($hook_hash));
	}
    ...
    {
        $ext = $col ? '_COL' : '';
        $nbr = Configuration::get('ST_SELLERS_NBR'.$ext);
        ($nbr===false && $col) && $nbr = Configuration::get('ST_SELLERS_NBR');
        ...
        $soby = (int)Configuration::get('ST_SELLERS_SOBY'.$ext);
        switch($soby)
        {
            case 1:
                $order_by = 'date_add';
		...
		*/
        ...
        $easing = Configuration::get('ST_SELLERS_EASING'.$ext);
        ($easing===false && $col) && $easing = Configuration::get('ST_SELLERS_EASING');
        
        $slideshow = Configuration::get('ST_SELLERS_SLIDESHOW'.$ext);
        ($slideshow===false && $col) && $slideshow = Configuration::get('ST_SELLERS_SLIDESHOW');
        
        $s_speed = Configuration::get('ST_SELLERS_S_SPEED'.$ext);
        ($s_speed===false && $col) && $s_speed = Configuration::get('ST_SELLERS_S_SPEED');
        
        $a_speed = Configuration::get('ST_SELLERS_A_SPEED'.$ext);
        ($a_speed===false && $col) && $a_speed = Configuration::get('ST_SELLERS_A_SPEED');
        
        $pause_on_hover = Configuration::get('ST_SELLERS_PAUSE_ON_HOVER'.$ext);
        ($pause_on_hover===false && $col) && $pause_on_hover = Configuration::get('ST_SELLERS_PAUSE_ON_HOVER');
        
        $loop = Configuration::get('ST_SELLERS_LOOP'.$ext);
        ($loop===false && $col) && $loop = Configuration::get('ST_SELLERS_LOOP');
        
        $move = Configuration::get('ST_SELLERS_MOVE'.$ext);
        ($move===false && $col) && $move = Configuration::get('ST_SELLERS_MOVE');
        
        $items = Configuration::get('ST_SELLERS_ITEMS'.$ext);
        ($items===false && $col) && $items = Configuration::get('ST_SELLERS_ITEMS');
        
        $hide_mob = Configuration::get('ST_SELLERS_HIDE_MOB'.$ext);
        ($hide_mob===false && $col) && $hide_mob = Configuration::get('ST_SELLERS_HIDE_MOB');

        $aw_display = Configuration::get('ST_SELLERS_AW_DISPLAY'.$ext);

        $display_sd = Configuration::get('ST_SELLERS_DISPLAY_SD');
        ...
        $this->smarty->assign(array(
            ...
            'display_as_grid'       => Configuration::get('ST_SELLERS_GRID'),
            'display_pro_col'       => Configuration::get('ST_SELLERS_DISPLAY_PRO_COL'),
    ...
    public function hookDisplayFooter($params, $hook_hash = '')
    {
	    ...
	    {
            $nbr = Configuration::get('ST_SELLERS_NBR_FOT');    
            $nbr = $nbr ? (int)$nbr : 4;
            
            $order_by = 'date_add';
            $order_way = 'DESC';
            
            $soby = (int)Configuration::get('ST_SELLERS_SOBY_FOT');
            switch($soby)
            {
                case 1:
                    $order_by = 'date_add';
            ...
            $this->smarty->assign(array(
    			...
    			'add_prod_display' => Configuration::get('PS_ATTRIBUTE_CATEGORY_DISPLAY'),
    			'thumbSize' => Image::getSize(ImageType::getFormatedName('thumb')),
                'aw_display' => Configuration::get('ST_SELLERS_AW_DISPLAY_FOT'),
                'hook_hash'=> $hook_hash,
    		));
	    }
    ...
    {
        $fields_values = array(
            'nbr'=> Configuration::get('ST_SELLERS_NBR'),
            'easing'=> Configuration::get('ST_SELLERS_EASING'),
            'slideshow'=> Configuration::get('ST_SELLERS_SLIDESHOW'),
            's_speed'=> Configuration::get('ST_SELLERS_S_SPEED'),
            'a_speed'=> Configuration::get('ST_SELLERS_A_SPEED'),
            'pause_on_hover'=> Configuration::get('ST_SELLERS_PAUSE_ON_HOVER'),
            'loop'=> Configuration::get('ST_SELLERS_LOOP'),
            'move'=> Configuration::get('ST_SELLERS_MOVE'),
            'items'=> Configuration::get('ST_SELLERS_ITEMS'),
            'soby'=> Configuration::get('ST_SELLERS_SOBY'),
            'hide_mob'=> Configuration::get('ST_SELLERS_HIDE_MOB'),
            'display_sd'=> Configuration::get('ST_SELLERS_DISPLAY_SD'),
            'aw_display'=> Configuration::get('ST_SELLERS_AW_DISPLAY'),
            'grid'=> Configuration::get('ST_SELLERS_GRID'),
            'countdown_on' => Configuration::get($this->_prefix_st.'COUNTDOWN_ON'),
                        
            'display_pro_col'=> Configuration::get('ST_SELLERS_DISPLAY_PRO_COL'),
            'nbr_col'=> Configuration::get('ST_SELLERS_NBR_COL'),
            'easing_col'=> Configuration::get('ST_SELLERS_EASING_COL'),
            'slideshow_col'=> Configuration::get('ST_SELLERS_SLIDESHOW_COL'),
            's_speed_col'=> Configuration::get('ST_SELLERS_S_SPEED_COL'),
            'a_speed_col'=> Configuration::get('ST_SELLERS_A_SPEED_COL'),
            'pause_on_hover_col'=> Configuration::get('ST_SELLERS_PAUSE_ON_HOVER_COL'),
            'loop_col'=> Configuration::get('ST_SELLERS_LOOP_COL'),
            'move_col'=> Configuration::get('ST_SELLERS_MOVE_COL'),
            'items_col'=> Configuration::get('ST_SELLERS_ITEMS_COL'),
            'soby_col'=> Configuration::get('ST_SELLERS_SOBY_COL'),
            'hide_mob_col'=> Configuration::get('ST_SELLERS_HIDE_MOB_COL'),
            'aw_display_col'=> Configuration::get('ST_SELLERS_AW_DISPLAY_COL'),
            'countdown_on_col' => Configuration::get($this->_prefix_st.'COUNTDOWN_ON_COL'),
            
            'nbr_fot'=> Configuration::get('ST_SELLERS_NBR_FOT'),
            'soby_fot'=> Configuration::get('ST_SELLERS_SOBY_FOT'),     
            'aw_display_fot'=> Configuration::get('ST_SELLERS_AW_DISPLAY_FOT'),   
