...
class StBlogRecentArticles extends Module
{
    ...
    private $_field_prefix = 'ST_B_RECENT_A_';
	...
	public function install()
	{
		if (!parent::install() 
            ...
            || !Configuration::updateValue($this->_field_prefix.'GRID', 1)
            ...
            || !Configuration::updateValue('STSN_BHOME_RB_PRO_PER_LG_0', 2)
            || !Configuration::updateValue('STSN_BHOME_RB_PRO_PER_MD_0', 1)
            || !Configuration::updateValue('STSN_BHOME_RB_PRO_PER_SM_0', 1)
            || !Configuration::updateValue('STSN_BHOME_RB_PRO_PER_XS_0', 1)
            || !Configuration::updateValue('STSN_BHOME_RB_PRO_PER_XXS_0', 1)
            || !Configuration::updateValue('STSN_HOME_RB_PRO_PER_LG_0', 4)
            || !Configuration::updateValue('STSN_HOME_RB_PRO_PER_MD_0', 4)
            || !Configuration::updateValue('STSN_HOME_RB_PRO_PER_SM_0', 3)
            || !Configuration::updateValue('STSN_HOME_RB_PRO_PER_XS_0', 2)
            || !Configuration::updateValue('STSN_HOME_RB_PRO_PER_XXS_0', 1)
            //
    ...
    public function hookDisplayHeader($params)
    {
        ...
        {
            $custom_css = '';
            $title_block_no_bg = 'body#index .st_blog_recent_article_container .title_block, body#index .st_blog_recent_article_container .nav_top_right .flex-direction-nav,body#index .st_blog_recent_article_container .title_block a, body#index .st_blog_recent_article_container .title_block span{background:none;}';
            ...
            if($group_css)
                $custom_css .= 'body#index .st_blog_recent_article_container{background-attachment:fixed;'.$group_css.'}'.$title_block_no_bg;

            if ($top_padding = (int)Configuration::get($this->_field_prefix.'TOP_PADDING'))
                $custom_css .= 'body#index .st_blog_recent_article_container{padding-top:'.$top_padding.'px;}';
            if ($bottom_padding = (int)Configuration::get($this->_field_prefix.'BOTTOM_PADDING'))
                $custom_css .= 'body#index .st_blog_recent_article_container{padding-bottom:'.$bottom_padding.'px;}';

            $top_margin = Configuration::get($this->_field_prefix.'TOP_MARGIN');
            if($top_margin || $top_margin!==null)
                $custom_css .= 'body#index .st_blog_recent_article_container{margin-top:'.$top_margin.'px;}';
            $bottom_margin = Configuration::get($this->_field_prefix.'BOTTOM_MARGIN');
            if($bottom_margin || $bottom_margin!==null)
                $custom_css .= 'body#index .st_blog_recent_article_container{margin-bottom:'.$bottom_margin.'px;}';

            if (Configuration::get($this->_field_prefix.'TITLE_ALIGNMENT'))
                $custom_css .= 'body#index .st_blog_recent_article_container .title_block{text-align:center;}'.$title_block_no_bg;
            ...
            {
                 $custom_css .= 'body#index .st_blog_recent_article_container .title_block{font-size:'.$title_font_size.'px;}';
                 $custom_css .= 'body#index .st_blog_recent_article_container .nav_top_right .flex-direction-nav{top:-'.(round((round($title_font_size*1.3)-24)/2)+24+22).'px;}';
            }

            if ($title_color = Configuration::get($this->_field_prefix.'TITLE_COLOR'))
                $custom_css .= 'body#index .st_blog_recent_article_container.block .title_block a, body#index .st_blog_recent_article_container.block .title_block span{color:'.$title_color.';}';
            
            if ($text_color = Configuration::get($this->_field_prefix.'TEXT_COLOR'))
                $custom_css .= 'body#index .st_blog_recent_article_container .s_title_block a,
                body#index .st_blog_recent_article_container .blog_info,
                body#index .st_blog_recent_article_container .blok_blog_short_content a.go,
                body#index .st_blog_recent_article_container .blok_blog_short_content{color:'.$text_color.';}';

            if ($link_hover_color = Configuration::get($this->_field_prefix.'LINK_HOVER_COLOR'))
                $custom_css .= 'body#index .st_blog_recent_article_container .s_title_block a:hover,
                body#index .st_blog_recent_article_container .blok_blog_short_content a.go:hover{color:'.$link_hover_color.';}';

            if ($direction_color = Configuration::get($this->_field_prefix.'DIRECTION_COLOR'))
                $custom_css .= 'body#index .st_blog_recent_article_container .flex-direction-nav a, body#index .st_blog_recent_article_container .nav_left_right .flex-direction-nav a{color:'.$direction_color.';}';
            if ($direction_bg = Configuration::get($this->_field_prefix.'DIRECTION_BG'))
                $custom_css .= 'body#index .st_blog_recent_article_container .flex-direction-nav a, body#index .st_blog_recent_article_container .nav_left_right .flex-direction-nav a{background-color:'.$direction_bg.';}';
            if ($direction_hover_bg = Configuration::get($this->_field_prefix.'DIRECTION_HOVER_BG'))
                $custom_css .= 'body#index .st_blog_recent_article_container .flex-direction-nav a:hover, body#index .st_blog_recent_article_container .nav_left_right .flex-direction-nav a:hover{background-color:'.$direction_hover_bg.';}';
            if ($direction_disabled_bg = Configuration::get($this->_field_prefix.'DIRECTION_DISABLED_BG'))
                $custom_css .= 'body#index .st_blog_recent_article_container .flex-direction-nav a.flex-disabled, body#index .st_blog_recent_article_container .nav_left_right .flex-direction-nav a.flex-disabled{background-color:'.$direction_disabled_bg.';}';
	...
	public function hookDisplayLeftColumn($params, $hook_hash='')
	{
        ...
        if (!$this->isCached('stblogrecentarticles-column.tpl', $this->stGetCacheId($hook_hash)))
	    {    
		...
		return $this->display(__FILE__, 'stblogrecentarticles-column.tpl', $this->stGetCacheId($hook_hash));
	}
    ...
    public function hookDisplayStBlogHome($params, $hook_hash='')
    {
        ...
        if (!$this->isCached('stblogrecentarticles-home.tpl', $this->stGetCacheId($hook_hash)))
	    {
            ...
            $this->smarty->assign(array(
                ...
                'pro_per_lg'            => Configuration::get('STSN_BHOME_RB_PRO_PER_LG_0') ? Configuration::get('STSN_BHOME_RB_PRO_PER_LG_0') : 4,
                'pro_per_md'            => Configuration::get('STSN_BHOME_RB_PRO_PER_MD_0') ? Configuration::get('STSN_BHOME_RB_PRO_PER_MD_0') : 4,
                'pro_per_sm'            => Configuration::get('STSN_BHOME_RB_PRO_PER_SM_0') ? Configuration::get('STSN_BHOME_RB_PRO_PER_SM_0') : 3,
                'pro_per_xs'            => Configuration::get('STSN_BHOME_RB_PRO_PER_XS_0') ? Configuration::get('STSN_BHOME_RB_PRO_PER_XS_0') : 2,
                'pro_per_xxs'           => Configuration::get('STSN_BHOME_RB_PRO_PER_XXS_0') ? Configuration::get('STSN_BHOME_RB_PRO_PER_XXS_0') : 1,
            ));
        }
        return $this->display(__FILE__, 'stblogrecentarticles-home.tpl', $this->stGetCacheId($hook_hash)); 
    }
    ...
    public function hookDisplayHome($params, $hook_hash = '', $flag=0)
    {
	    ...
	    {      
            ...
            $this->smarty->assign(array(
                ...
                'display_as_grid'       => Configuration::get($this->_field_prefix.'GRID_H'),
    
                'pro_per_lg'            => Configuration::get('STSN_HOME_RB_PRO_PER_LG_0') ? Configuration::get('STSN_HOME_RB_PRO_PER_LG_0') : 4,
                'pro_per_md'            => Configuration::get('STSN_HOME_RB_PRO_PER_MD_0') ? Configuration::get('STSN_HOME_RB_PRO_PER_MD_0') : 4,
                'pro_per_sm'            => Configuration::get('STSN_HOME_RB_PRO_PER_SM_0') ? Configuration::get('STSN_HOME_RB_PRO_PER_SM_0') : 3,
                'pro_per_xs'            => Configuration::get('STSN_HOME_RB_PRO_PER_XS_0') ? Configuration::get('STSN_HOME_RB_PRO_PER_XS_0') : 2,
                'pro_per_xxs'           => Configuration::get('STSN_HOME_RB_PRO_PER_XXS_0') ? Configuration::get('STSN_HOME_RB_PRO_PER_XXS_0') : 1,
    ...
    public function hookDisplayFooter($params, $hook_hash = '')
    {
        ...
        if (!$this->isCached('stblogrecentarticles-footer.tpl', $this->stGetCacheId($hook_hash)))
	    {      
		...
		return $this->display(__FILE__, 'stblogrecentarticles-footer.tpl', $this->stGetCacheId($hook_hash));
    }
