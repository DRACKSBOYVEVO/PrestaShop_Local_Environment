...
{strip}
{addJsDefL name=ins_follow}{l s='Follow' mod='stinstagram' js=1}{/addJsDefL}
{addJsDefL name=ins_posts}{l s='Posts' mod='stinstagram' js=1}{/addJsDefL}
{addJsDefL name=ins_followers}{l s='Followers' mod='stinstagram' js=1}{/addJsDefL}
{addJsDefL name=ins_following}{l s='Following' mod='stinstagram' js=1}{/addJsDefL}
{/strip}
<!-- /MODULE ST instagram -->