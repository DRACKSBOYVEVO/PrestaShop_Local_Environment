...
class StInstagram extends Module
{
	...
	function install()
	{
		if (!parent::install() 
            ...
            || !Configuration::updateValue($this->_prefix_st.'CLIENT_ID', '')
        ...
        $this->fields_form[0]['form'] = array(
            ...
            'input' => array(
                ...
                array(
                    ...
                    'desc' => '<p>'.sprintf($this->l('How to get the Client ID ? click %s here'), '<a href="http://sunnytoo.com/instagram/how_to_get_client_id.html" target="_blank">').'</a>.</p>'.
    ...
    private function _prepareHook()
    {
        $this->smarty->assign(array(
            'ins_client_id'    => Configuration::get($this->_prefix_st.'CLIENT_ID'),
    ...
    private function _grantUserInfo()
    {
        ...
        {
            $this->smarty->assign(array(
                'client_id' => Configuration::get($this->_prefix_st.'CLIENT_ID'),//'e3f9c646bc3d42d88272b45c96355f7d',
