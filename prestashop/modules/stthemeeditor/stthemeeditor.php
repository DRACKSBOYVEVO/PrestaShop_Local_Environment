...
{	
	...
	public function __construct()
	{
        ...
        $this->defaults = array(
            ...
            'welcome_link'                  => array('exp'=>0,'val'=> array('1'=>'')),
            ...
            'addtocart_animation'           => array('exp'=>0,'val'=> 0),
            ...
            /*
    		"font_title"                    => array('exp'=>0,'val'=> 'Fjalla One:400'),
            ...
            */
            ...
            "font_arabic_support"               => array('exp'=>0,'val'=>0),
            //style
            ...
            'show_brand_logo'               => array('exp'=>0,'val'=> 1),
            ...
            //header
            'header_padding'            => array('exp'=>0,'val'=>0),
            ...
            'cs_per_xs_0'                   => array('exp'=>0,'val'=> 3),
            'cs_per_xxs_0'                  => array('exp'=>0,'val'=> 2),
            //productcategory
            'pc_easing'                     => array('exp'=>0,'val'=> 0),
            ...
            'pc_per_xs_0'                   => array('exp'=>0,'val'=> 3),
            'pc_per_xxs_0'                  => array('exp'=>0,'val'=> 2),
            //accessories
            'ac_easing'                     => array('exp'=>0,'val'=> 0),
            ...
            'ac_per_xs_0'                   => array('exp'=>0,'val'=> 3),
            'ac_per_xxs_0'                  => array('exp'=>0,'val'=> 2),
            //color
            ...
            //
            'cate_sortby'                   => array('exp'=>0,'val'=> ''),
            'cate_sortby_name'              => array('exp'=>0,'val'=> ''),
            //
            ...
            'hometab_pro_per_lg_0'          => array('exp'=>0,'val'=> 4),
            'hometab_pro_per_md_0'          => array('exp'=>0,'val'=> 4),
            'hometab_pro_per_sm_0'          => array('exp'=>0,'val'=> 3),
            'hometab_pro_per_xs_0'          => array('exp'=>0,'val'=> 2),
            'hometab_pro_per_xxs_0'         => array('exp'=>0,'val'=> 1),

            'packitems_pro_per_lg_0'        => array('exp'=>0,'val'=> 4),
            'packitems_pro_per_md_0'        => array('exp'=>0,'val'=> 4),
            'packitems_pro_per_sm_0'        => array('exp'=>0,'val'=> 3),
            'packitems_pro_per_xs_0'        => array('exp'=>0,'val'=> 2),
            'packitems_pro_per_xxs_0'       => array('exp'=>0,'val'=> 1),

            'categories_per_lg_0'           => array('exp'=>0,'val'=> 5),
            'categories_per_md_0'           => array('exp'=>0,'val'=> 5),
            'categories_per_sm_0'           => array('exp'=>0,'val'=> 4),
            'categories_per_xs_0'           => array('exp'=>0,'val'=> 3),
            ...
            'mail_color'                    => array('exp'=>0,'val'=> ''),
            'top_spacing'                   => array('exp'=>0,'val'=> 0),   
            'bottom_spacing'                => array('exp'=>0,'val'=> 0),   
            'display_pro_condition'         => array('exp'=>0,'val'=> 1),   
            'display_pro_reference'         => array('exp'=>0,'val'=> 1),   
            ...
            'adv_menu_ver_open'                  => array('exp'=>0,'val'=> 0),
            ...
            'use_mobile_header'                => array('exp'=>0,'val'=>0),
            ...
            'menu_icon_with_text'                => array('exp'=>0,'val'=>0),  
            'pro_img_hover_scale'                => array('exp'=>0,'val'=>0),  
            'pro_show_print_btn'                => array('exp'=>0,'val'=>0),
            ...
            'f_info_center'                => array('exp'=>0,'val'=>0),
        );
        ...
        $this->fields_form[14]['form'] = array(
			'input' => array(
                ...
                array(
					...
					'rows' => 20,
                    'validation' => 'isAnything',
                    'desc' => $this->l('Code added here is injected before the closing body tag on every page in your site. Turn on the "Use HTMLPurifier Library" setting on the Preferences > General page if you want to put html codes into this field.'),
				),
                array(
                    'type' => 'textarea',
                    ...
                    'cols' => 80,
                    'rows' => 20,
                    'desc' => $this->l('Code added here is injected into the head tag on every page in your site. Turn on the "Use HTMLPurifier Library" setting on the Preferences > General page if you want to put html tags into this field.'),
                    'validation' => 'isAnything',
                ),
            ),
			'submit' => array(
                ...
                array(
                    ...
                    'values' => array(
                        array(
                            ...
                            'value' => 0,
                            'label' => $this->l('Under product images.')),
                        array(
                            'id' => 'product_tabs_right',
                            'value' => 1,
                            'label' => $this->l('On the right side of product images.')),
                    ),
                    'validation' => 'isUnsignedInt',
                ), 
                array(
        ...
        $html .= '<form class="defaultForm form-horizontal" action="'.AdminController::$currentIndex.'&configure='.$this->name.'&upload'.$this->name.'&token='.$token.'" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
            	<div class="col-sm-6">
                    ...
                    <button type="submit" value="1" name="uploadconfig" id="uploadconfig" class="btn btn-default" data="'.$this->l('Your current settings will be overrided, are your sure?').'"><i class="icon icon-upload"></i> '.$this->l('Upload').'</button>
            	</div>
            </div>
            </div>
            </div>
