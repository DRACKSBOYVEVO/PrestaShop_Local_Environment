<?php /* Smarty version Smarty-3.1.19, created on 2021-10-22 11:14:24
         compiled from "C:\laragon\www\prestashop_1.6.1.24\prestashop\themes\transformer\product-slider.tpl" */ ?>
<?php /*%%SmartyHeaderCode:15700747086172e360567389-32749398%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '529045adba049f3cfd5b2f239ea14fc7b5d23a6a' => 
    array (
      0 => 'C:\\laragon\\www\\prestashop_1.6.1.24\\prestashop\\themes\\transformer\\product-slider.tpl',
      1 => 1633442184,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '15700747086172e360567389-32749398',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_6172e3607a8465_25261887',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_6172e3607a8465_25261887')) {function content_6172e3607a8465_25261887($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include 'C:\\laragon\\www\\prestashop_1.6.1.24\\prestashop\\tools\\smarty\\plugins\\modifier.date_format.php';
?>
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
            ...
            <div class="pro_first_box <?php if (isset($_smarty_tpl->tpl_vars['sttheme']->value['flyout_buttons'])&&$_smarty_tpl->tpl_vars['sttheme']->value['flyout_buttons']) {?>hover_fly_static<?php }?> ">
                <a href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['link'], ENT_QUOTES, 'UTF-8', true);?>
" title="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
" class="product_image<?php if ($_smarty_tpl->tpl_vars['pro_img_hover_scale']->value) {?> pro_img_hover_scale<?php }?>"><img src="<?php echo $_smarty_tpl->tpl_vars['pro_image']->value;?>
                ...
                <div class="price_container">
                    ...
                    <?php if (isset($_smarty_tpl->tpl_vars['product']->value['specific_prices'])&&$_smarty_tpl->tpl_vars['product']->value['specific_prices']&&isset($_smarty_tpl->tpl_vars['product']->value['specific_prices']['reduction'])&&$_smarty_tpl->tpl_vars['product']->value['specific_prices']['reduction']>0) {?>
                        ...
                        <span class="sale_percentage">
                            <i class="icon-tag"></i>-<?php if ($_smarty_tpl->tpl_vars['product']->value['specific_prices']&&$_smarty_tpl->tpl_vars['product']->value['specific_prices']['reduction_type']=='percentage') {?><?php echo round(($_smarty_tpl->tpl_vars['product']->value['specific_prices']['reduction']*100),2);?>
...
<?php }?>
            ...
            <?php if (isset($_smarty_tpl->tpl_vars['display_sd']->value)&&$_smarty_tpl->tpl_vars['display_sd']->value) {?><div class="product-desc"><?php if ($_smarty_tpl->tpl_vars['display_sd']->value==2) {?><?php echo $_smarty_tpl->tpl_vars['product']->value['description_short'];?>
<?php } else { ?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['truncate'][0][0]->smarty_modifier_truncate(strip_tags($_smarty_tpl->tpl_vars['product']->value['description_short']),120,'...');?>
<?php }?></div><?php }?>
