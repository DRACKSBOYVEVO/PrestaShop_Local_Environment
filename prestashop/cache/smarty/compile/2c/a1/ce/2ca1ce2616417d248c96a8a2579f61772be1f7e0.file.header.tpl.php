<?php /* Smarty version Smarty-3.1.19, created on 2021-10-22 11:14:26
         compiled from "C:\laragon\www\prestashop_1.6.1.24\prestashop\themes\transformer\header.tpl" */ ?>
<?php /*%%SmartyHeaderCode:20805434826172e362017890-49311734%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2ca1ce2616417d248c96a8a2579f61772be1f7e0' => 
    array (
      0 => 'C:\\laragon\\www\\prestashop_1.6.1.24\\prestashop\\themes\\transformer\\header.tpl',
      1 => 1633442183,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '20805434826172e362017890-49311734',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_6172e36210f297_03698050',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_6172e36210f297_03698050')) {function content_6172e36210f297_03698050($_smarty_tpl) {?><?php if (!is_callable('smarty_function_implode')) include 'C:\\laragon\\www\\prestashop_1.6.1.24\\prestashop\\tools\\smarty\\plugins\\function.implode.php';
?>
...
<?php }?>
	...
	<?php $_smarty_tpl->tpl_vars['use_mobile_header'] = new Smarty_variable(Configuration::get('STSN_USE_MOBILE_HEADER'), null, 0);?>
...
?>
		...
		<?php }?>
	<?php } ?>
	<?php if ($_smarty_tpl->tpl_vars['sttheme']->value['is_mobile_device']) {?> mobile_device <?php if ($_smarty_tpl->tpl_vars['use_mobile_header']->value==1) {?> use_mobile_header <?php }?><?php }?><?php if ($_smarty_tpl->tpl_vars['slide_lr_column']->value) {?> slide_lr_column <?php }?>
	<?php if ($_smarty_tpl->tpl_vars['use_mobile_header']->value==2) {?> use_mobile_header <?php }?>
	">
...
<?php if (isset($_smarty_tpl->tpl_vars['geolocation_country']->value)&&$_smarty_tpl->tpl_vars['geolocation_country']->value) {?> <span class="bold"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['geolocation_country']->value, ENT_QUOTES, 'UTF-8', true);?>
		...
		<div id="body_wrapper">
			...
			<header id="page_header" class="<?php if ($_smarty_tpl->tpl_vars['sttheme']->value['transparent_header']) {?> transparent_header <?php }?> <?php if (Configuration::get('STSN_TRANSPARENT_MOBILE_HEADER')) {?> transparent-mobile-header <?php }?>">
...
"<?php }?>/>
 ...
 <?php }?> text-right">
	            ...
	            <?php if (!isset($_smarty_tpl->tpl_vars['HOOK_MAIN_EMNU_WIDGET']->value)) {?>
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
				...
				<?php if ((isset($_smarty_tpl->tpl_vars['HOOK_MAIN_EMNU_WIDGET']->value)&&trim($_smarty_tpl->tpl_vars['HOOK_MAIN_EMNU_WIDGET']->value))||(isset(Smarty::$_smarty_vars['capture']['displayMainMenuWidget'])&&trim(Smarty::$_smarty_vars['capture']['displayMainMenuWidget']))) {?><?php $_smarty_tpl->tpl_vars['has_widgets'] = new Smarty_variable(1, null, 0);?><?php }?>
				<?php $_smarty_tpl->tpl_vars['megamenu_width'] = new Smarty_variable(Configuration::get('STSN_ADV_MEGAMENU_WIDTH'), null, 0);?>
	            <?php if ((isset($_smarty_tpl->tpl_vars['HOOK_TOP_SECONDARY']->value)&&$_smarty_tpl->tpl_vars['HOOK_TOP_SECONDARY']->value)||$_smarty_tpl->tpl_vars['has_widgets']->value) {?>
	            <section id="top_extra" class="main_menu_has_widgets_<?php echo $_smarty_tpl->tpl_vars['has_widgets']->value;?>
">
	            	<?php if (!isset($_smarty_tpl->tpl_vars['megamenu_width']->value)||!$_smarty_tpl->tpl_vars['megamenu_width']->value) {?><div class="wide_container boxed_advancedmenu"><?php }?>
					<div id="st_advanced_menu_container" class="animated fast">
						<div class="container">
			            	<div class="container_inner clearfix">
				            	<?php if ($_smarty_tpl->tpl_vars['has_widgets']->value) {?>
				            		<div id="main_menu_widgets" class="clearfix">
					            	<?php if (isset($_smarty_tpl->tpl_vars['HOOK_MAIN_EMNU_WIDGET']->value)) {?><?php echo $_smarty_tpl->tpl_vars['HOOK_MAIN_EMNU_WIDGET']->value;?>
<?php }?>
...
<?php }?>
					...
					<?php if (!isset($_smarty_tpl->tpl_vars['megamenu_width']->value)||!$_smarty_tpl->tpl_vars['megamenu_width']->value) {?></div><?php }?> 
				</section>
	            <?php }?>
